...
To override a private variable, we declare a variable using $ sign. To access using instance $this->var use no $ sign.
...
Values == data
                                        variables == keys = index !== strings or need no quote unless spaced between or begin with number.g