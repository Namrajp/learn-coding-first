...
slice(1 or 2),
toUpperCase, replace(/gi,b),
trim, string.split("  "),
string.length.

 ##	Object methods: 
new, Object.create()/.keys()/.values()/.entries/.assign/.freeze/.seal
...
bind, apply, call
 ##	Prototypes:
[[prototype]],__proto__,Object.prototype, Array.prototype, Date.proto, String.proto
...
##	Constructor: blueprint.newObj, function, call, new.prototype.method.
 ...
 11.	this: in general/function-> window, in methods->object, 
in constructor-> new obj,
